...
def main():
    ...
    if args.multiprocessing_distributed:
        ...
        mp.spawn(main_worker, nprocs=ngpus_per_node, args=(ngpus_per_node,args)) # multi-processing
    else:
...
def main_worker(gpu,ngpus_per_node, args):
    ...
    for cur_iter in range(args.num_tasks):
        ...
        for i, data in enumerate(cur_train_datalist):
            ...
            if samples_cnt % args.stream_eval_period == 0:
                eval_dict = method.online_evaluate(test_datalist, samples_cnt, 32, args.n_worker)
